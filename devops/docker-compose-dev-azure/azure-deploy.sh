...
resourcename="waterminderv1.0"  # lower case, only
resourcegroup="waterminderv1.0_rg"
...
# git clone https://github.com/apilogicserver/waterminderv1.0.git
# cd waterminderv1.0
...
az group create --name waterminderv1.0_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group waterminderv1.0_rg --sku S1 --is-linux
az container create --resource-group waterminderv1.0_rg --name waterminderv1.0 --image apilogicserver/waterminderv1.0:latest --dns-name-label waterminderv1.0 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//waterminderv1.0.westus.azurecontainer.io:5656'
