...
@Component({
  selector: 'CustomChallenge-home',
  templateUrl: './CustomChallenge-home.component.html',
  styleUrls: ['./CustomChallenge-home.component.scss']
})
export class CustomChallengeHomeComponent implements AfterViewInit {
