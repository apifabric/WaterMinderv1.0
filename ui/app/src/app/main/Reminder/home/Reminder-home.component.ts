...
@Component({
  selector: 'Reminder-home',
  templateUrl: './Reminder-home.component.html',
  styleUrls: ['./Reminder-home.component.scss']
})
export class ReminderHomeComponent implements AfterViewInit {
