...
@Component({
  selector: 'UserChallenge-home',
  templateUrl: './UserChallenge-home.component.html',
  styleUrls: ['./UserChallenge-home.component.scss']
})
export class UserChallengeHomeComponent implements AfterViewInit {
