...
@Component({
  selector: 'ProgressMilestone-home',
  templateUrl: './ProgressMilestone-home.component.html',
  styleUrls: ['./ProgressMilestone-home.component.scss']
})
export class ProgressMilestoneHomeComponent implements AfterViewInit {
