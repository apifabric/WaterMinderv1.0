...
@Component({
  selector: 'UserNotification-home',
  templateUrl: './UserNotification-home.component.html',
  styleUrls: ['./UserNotification-home.component.scss']
})
export class UserNotificationHomeComponent implements AfterViewInit {
