...
@Component({
  selector: 'WaterConsumption-home',
  templateUrl: './WaterConsumption-home.component.html',
  styleUrls: ['./WaterConsumption-home.component.scss']
})
export class WaterConsumptionHomeComponent implements AfterViewInit {
