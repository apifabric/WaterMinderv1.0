...
@Component({
  selector: 'UserAchievement-home',
  templateUrl: './UserAchievement-home.component.html',
  styleUrls: ['./UserAchievement-home.component.scss']
})
export class UserAchievementHomeComponent implements AfterViewInit {
