...
@Component({
  selector: 'WaterIntakeGoal-home',
  templateUrl: './WaterIntakeGoal-home.component.html',
  styleUrls: ['./WaterIntakeGoal-home.component.scss']
})
export class WaterIntakeGoalHomeComponent implements AfterViewInit {
