...
@Component({
  selector: 'HydrationSetting-home',
  templateUrl: './HydrationSetting-home.component.html',
  styleUrls: ['./HydrationSetting-home.component.scss']
})
export class HydrationSettingHomeComponent implements AfterViewInit {
